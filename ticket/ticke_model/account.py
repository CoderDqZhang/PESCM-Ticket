...
class Account(models.Model):
    ...
    gender = models.CharField('性别', max_length=7, choices=(('male', u'男'), ('female', '女')), default='female')
    ...
    status = models.CharField('甲乙区分', default = '0', max_length=7, choices=USER_STATUS, null=True) #甲乙区分 0代表甲方，1代表乙方
